...
import OrdersIcon from "../../../../assets/images/dashboard/bookings.png"
...
const staticsBuyerData = [
    {
        icon: <img src={OrdersIcon} alt={OrdersIcon} />,
...
const staticsSupplierData = [
    ...
    {
        description: "Booking On Transit",
        title: "Booking On Transit",
        stats: "53",
        data: [47, 45, 74, 14, 56, 74, 14, 11, 7, 39, 82]
    }
]
...
const staticsFleetOwnerData = [
    {
        icon: <img src={OrdersIcon} alt={OrdersIcon} width={64} />,
        description: "Open Orders",
        title: "Open Orders",
        stats: "22",
        data: [25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54],

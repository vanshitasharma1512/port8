              ...
              <Table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><Link to="/material-procurement/supplier-profile" className="btn btn-default"><i className="mdi mdi-eye"></i></Link>
          ...
          <Card>
            <Card.Body>
              <Form>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  <Form.Label>Uplode PO</Form.Label>
...
export default TranspReqUserBids;

                            ...
                            <Row className="mb-2">
                                ...
                                <Col sm={7}>
                                    <div className="text-sm-end">
                                        ...
                                        <Button onClick={() => changePageData("supply")} variant="danger" className={activeBtn === "supply" ? "mb-2 me-1 btnActive" : "mb-2 me-1"} >
                                            Supply
                                        </Button>
                                        <Button onClick={() => changePageData("transport")} variant="danger" className={activeBtn === "transport" ? "mb-2 me-1 btnActive" : "mb-2 me-1"}>
                                            Transport
                                        </Button>
                                    </div>
                                </Col>
                                ...
                                <Row>
                                    <Col sm={2}>
                                        <Form.Group as={Col} controlId="TruckType">
                                            <Form.Label>{activeBtn==="transport"&&"Pickup "} Location</Form.Label>
